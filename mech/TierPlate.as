package mech {
	...
	public class TierPlate extends FlxSprite {
		...
		[Embed(source="../assets/tier_plate.gif")]
		private var plate_img : Class;
	
		public function TierPlate(pos_x : int, pos_y : int, facing_ : uint) {
			motion_array = [];
			
			this.loadGraphic(plate_img, true, true, 48, 16);
			this.facing = facing_;
